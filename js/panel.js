...
<!---Credit to SnowLord7 for Dev Console https://github.com/SnowLord7/devconsole + Error page from Replit---!>
...
<body>
	<div class="err-box">
		...
		<div>
			<div>Return to <a href="javascript:window.history.back()">last page</a>?</div>
		</div>
	</div>
</body>
  ...
  if (localStorage.getItem("devConsole") === "true") {
    devConsole.checked = true;
  } 
...
function save() {
  if (devConsole.checked === true) {
    console.log("yes dev console");
    localStorage.setItem("devConsole", "true");
  } else if (devConsole.checked === false) {
    console.log("no dev console");
    localStorage.setItem("devConsole", "false");
  } 
